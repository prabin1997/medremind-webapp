    ...
    function sendReminder(appointments) {
      ...
      appointments.forEach(function(appointment) {
          ...
          const options = {
              ...
              from: cfg.twilioPhoneNumber,
              /* eslint-disable max-len */
              body: `Hi there. Just a reminder that you still have not taken your ${appointment.name} medication.\nIf you taken the medication please click on this link to confirm: https://medremind-app.herokuapp.com/appointments/${appointment._id}/${appointment.name}/fullMed `, 
              /* eslint-enable max-len */
          };
